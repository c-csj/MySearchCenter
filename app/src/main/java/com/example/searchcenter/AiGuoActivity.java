...
public class AiGuoActivity extends ListActivity implements AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
    private String TAG = "AiGuoActivity";
    Handler handler;
        ...
        Handler handler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                if (msg.what == 7) {
                    ...
                    listItemAdapter = new SimpleAdapter(AiGuoActivity.this, listItems,
                            R.layout.listitem,
