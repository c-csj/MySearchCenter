...
public class ShuQingActivity extends ListActivity implements AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
    private String TAG = "ShuQingActivity";
    Handler handler;
        ...
        Handler handler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                if (msg.what == 7) {
                    ...
                    listItemAdapter = new SimpleAdapter(ShuQingActivity.this, listItems,
                            R.layout.listitem,
