...
public class SongBieActivity extends ListActivity implements AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
    private String TAG = "SongBieActivity";
    Handler handler;
        ...
        Handler handler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                if (msg.what == 7) {
                    ...
                    listItemAdapter = new SimpleAdapter(SongBieActivity.this, listItems,
                            R.layout.listitem,
