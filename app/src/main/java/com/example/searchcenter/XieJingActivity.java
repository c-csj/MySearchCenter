...
public class XieJingActivity extends ListActivity implements AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
        ...
        Handler handler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                if (msg.what == 7) {
                    ...
                    listItemAdapter = new SimpleAdapter(XieJingActivity.this, listItems,
                            R.layout.listitem,
